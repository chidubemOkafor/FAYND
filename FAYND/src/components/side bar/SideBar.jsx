...
const SideBar = () => {
  return (
    <div className='sidebar_div_main'>
        <div>
            <img src={faynd} alt='faynd logo' className='faynd_mini_logo'/>
        </div>
        <ul>
            ...
            <li className='list_side_icon'><img src={bellicon} alt='icon' className='sidebar_icons'/><p className='sidebar_text'>Notification</p></li>
            <li className='list_side_icon'><img src={priceicon} alt='icon' className='sidebar_icons'/><p className='sidebar_text'>Pricing</p></li>
            <li className='list_side_icon'><img src={itemicon} alt='icon' className='sidebar_icons'/><p className='sidebar_text'>Items</p></li>
